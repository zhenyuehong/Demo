...
package com.mtelnet.flipviewlibrary.flip;


import com.mtelnet.flipviewlibrary.utils.AphidLog;
...
import static com.mtelnet.flipviewlibrary.flip.FlipRenderer.checkError;
import static com.mtelnet.flipviewlibrary.utils.TextureUtils.d2r;
import static com.mtelnet.flipviewlibrary.utils.TextureUtils.isValidTexture;
import static com.mtelnet.flipviewlibrary.utils.TextureUtils.toFloatBuffer;
import static com.mtelnet.flipviewlibrary.utils.TextureUtils.toShortBuffer;
    ...
    if (angle > 0) {
      ...
      if (axis == AXIS_TOP) {
        if (orientationVertical) {
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (float)(1.0f - cos(d2r(angle)));
        ...
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (float)(1f - cos(d2r(angle)));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * (float)sin(d2r(angle));
          shadowVertices = new float[]{
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (float)(1f - cos(d2r(angle)));
          z = (cardVertices[X_10] - cardVertices[X_00]) * (float)sin(d2r(angle));
          shadowVertices = new float[]{
              cardVertices[X_00], cardVertices[Y_00], 0f,
              cardVertices[X_01], cardVertices[Y_01], 0f,
