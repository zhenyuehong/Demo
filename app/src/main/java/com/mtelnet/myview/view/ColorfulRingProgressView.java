...
//    private int mFgColorStart = 0xffffe400;
    private int mFgColorStart = 0xffff4800;
    ...
    public ColorfulRingProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mFgColorEnd = a.getColor(R.styleable.ColorfulRingProgressView_fgColorEnd, mFgColorEnd);

            mFgColorStart = a.getColor(R.styleable.ColorfulRingProgressView_fgColorStart, mFgColorStart);
