...
/**
 * Created by hongzhenyue on 16/12/13.
 */
...
public class FlyBanner extends RelativeLayout {
    ...
    private void setLayout(Context context) {
        ...
        //设置内边距
        pointContainerRl.setPadding(Utils.dip2px(context,50), Utils.dip2px(context,10),
                Utils.dip2px(context,100), Utils.dip2px(context,10));
        //设定指示器容器布局及位置
        ...
        mPointRealContainerLp.bottomMargin = Utils.dip2px(context,7);
