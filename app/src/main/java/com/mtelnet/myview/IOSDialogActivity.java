...
public class IOSDialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_show_city).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CityPickerView mCityPickerView = new CityPickerView(IOSDialogActivity.this);
                // 设置点击外部是否消失
...
//        mCityPickerView.setTextSize(18f);
        ...
        mCityPickerView.setHeadBackgroundColor(Color.RED);
                mCityPickerView.setOnCitySelectListener(new CityPickerView.OnCitySelectListener() {
                    ...
                    public void onCitySelect(String str) {
                        Toast.makeText(IOSDialogActivity.this, str, Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        findViewById(R.id.btn_show_time).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerView mTimePickerView = new TimePickerView(IOSDialogActivity.this, TimePickerView.Type.YEAR_MONTH_DAY);
                // 设置是否循环
...
//        mTimePickerView.setTime(new Date());
                mTimePickerView.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
                    ...
                    public void onTimeSelect(Date date) {
                        ...
                        Toast.makeText(IOSDialogActivity.this, format.format(date), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        findViewById(R.id.btn_show_item).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                OptionsPickerView<String> mOptionsPickerView = new OptionsPickerView<>(IOSDialogActivity.this);
...
//        mOptionsPickerView.setLabels("性");
                mOptionsPickerView.setOnOptionsSelectListener(new OptionsPickerView.OnOptionsSelectListener() {
                    ...
                    public void onOptionsSelect(int option1, int option2, int option3) {
                        ...
                        Toast.makeText(IOSDialogActivity.this, sex, Toast.LENGTH_SHORT).show();
                    }
                });
